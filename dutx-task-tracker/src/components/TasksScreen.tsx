...
export default function TasksScreen({
  ...
  return (
    <div className="relative min-h-full h-full flex-1 bg-background text-on-surface flex flex-col pb-24 font-sans">
      ...
      <motion.button
        ...
        className="fixed bottom-24 right-5 w-14 h-14 bg-primary-container text-on-primary-container rounded-full flex items-center justify-center shadow-lg z-30 hover:brightness-110 cursor-pointer text-white"
      >
